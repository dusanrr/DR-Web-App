...
{
  var imeprezime = document.kkorisniks.imeprezime;
  var lozinka = document.kkorisniks.lozinka;
  var email = document.kkorisniks.email;
  ...
  if(pass_validation(lozinka,7,12))
  {
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        $q="select * from korisnici where email='$email'";
        $stmt = $conn->prepare($q);
        $stmt->execute();
        ...
        if($row != null)
        {
          $_SESSION['porukaf'] = "Korisnik sa unetim emailom vec postoji.";
        }
        else
        {
          $query="insert into korisnici(ime_prezime,email,lozinka) values('$ip','$email','$lozinka')";
          $conn->exec($query);
          $_SESSION['porukas'] = "Uspesno ste kreirali korisnika.";
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Kreiranje korisnika</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
              ...
              <div class="row">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <strong>Kreiranje korisnika</strong>
                    </div>
                    <div class="card-body card-block">
                        <form method="post" enctype="multipart/form-data" name="kkorisniks" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Ime i prezime</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="imeprezime" class="form-control">
                                    <small class="form-text text-muted">Format(Ime Prezime)</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <small class="help-block form-text">Unesite email adresu korisnika</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="password" id="password-input" name="lozinka" class="form-control">
                                    <small class="help-block form-text">Unesite lozinku korisnika</small>
                                </div>
                            </div>
                    </div>
                    <div class="card-footer">
                        ...
                        <a href="kkorisnika.php" type="reset" class="btn btn-danger btn-sm">
