<?php session_start();
  if($_SESSION['ulogovan'] == false)
  {
    ...
    $mid=$_GET['mid'];
    $page = $_GET['page'];
    $q="select * from materijal where id='$mid'";
    $stmt = $conn->prepare($q);
    $stmt->execute();
...
<head>
    ...
    //IZMENA MATERIJALA VALIDACIJA
    function formValidation()
    {
      var nm = document.imats.nm;
      var stanje = document.imats.stanje;

      if(isnm(nm))
      {
      if(allnumeric(stanje))
      {
          document.imats.submit();
          <?php
                            ...
                            <div class="au-breadcrumb-content">
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        ...
                                        <li class="list-inline-item">Izmena materijala</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
              ...
              <div class="row" style="padding-bottom: 100px;">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <strong>Izmena materijala</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="izmeni.php?page=<?php echo $page; ?>" method="post" name="imats" enctype="multipart/form-data" class="form-horizontal">
                          <?php if($row != null)
                					{
                            echo'<div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="mid" hidden="true" class="form-control" value="'.$row['id'].'">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="nm" class="form-control" value="'.$row['naziv'].'">
                                    <small class="form-text text-muted">Naziv materijala</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="email-input" class=" form-control-label">Stanje</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="stanje" class="form-control" value="'.$row['stanje'].'">
                                    <small class="help-block form-text">Stanje</small>
                                </div>
                            </div>';
                          } ?>
                    </div>
