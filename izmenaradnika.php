<?php session_start();
  if($_SESSION['ulogovan'] == false)
  {
    ...
    $rid=$_GET['rid'];
    $page = $_GET['page'];
    $q="select * from radnici where id='$rid'";
    $stmt = $conn->prepare($q);
    $stmt->execute();
...
<head>
    ...
    //IZMENA RADNIKA VALIDACIJA
    function formValidation()
    {
      var ip = document.irad.ip;
      var satnica = document.irad.satnica;
      var dani = document.iradirad.dani;
      var sati = document.irad.sati;
                                ...
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        <li class="list-inline-item active">
                                            <a href="radnici.php">Radnici</a>
                                        </li>
                                        <li class="list-inline-item seprate">
                                            <span>/</span>
                                        </li>
                                        <li class="list-inline-item">Izmena radnika</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
              ...
              <div class="row" style="padding-bottom: 100px;">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        <strong>Izmena radnika</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="izmeni.php?page=<?php echo $page; ?>" method="post" name="irad" enctype="multipart/form-data" class="form-horizontal">
                          <?php if($row != null)
                					{
                            echo'<div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="rid" hidden="true" class="form-control" value="'.$row['id'].'">
                                </div>
                            </div>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="ip" class="form-control" value="'.$row['imeprezime'].'">
                                    <small class="form-text text-muted">Ime i prezime</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="email-input" class=" form-control-label">Satnica</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="satnica" class="form-control" value="'.$row['satnica'].'">
                                    <small class="help-block form-text">Satnica</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="email-input" class=" form-control-label">Radni dani</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="dani" class="form-control" value="'.$row['radni_dani'].'">
                                    <small class="help-block form-text">Radni dani</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="email-input" class=" form-control-label">Trenutni radni sati</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="tsati" class="form-control" readonly="true" value="'.$row['radni_sati'].'">
                                    <small class="help-block form-text">Trenutni radni sati</small>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="email-input" class=" form-control-label">Dodaj/smanji radne sate</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="sati" class="form-control"">
                                    <small class="help-block form-text">Dodaj/smanji radne sate</small>
                                </div>
                            </div>
                            ';
                          } ?>
