...
<head>
  ...
  <script type="text/javascript">
    ...
    {
      var naziv = document.forma.naziv;
      if(isnts(naziv))
      {
          ...
          if ($_SERVER['REQUEST_METHOD'] == 'POST')
          {
            ...
            {
              $nts=$_POST['naziv'];
              $q="select * from ts where naziv='$nts'";
              $stmt = $conn->prepare($q);
              $stmt->execute();
              ...
              if($row != null)
              {
                $_SESSION['porukaf'] = "Trafo stanica sa unetim nazivom vec postoji.";
              }
              else
              {
                $query="insert into ts(naziv) values('$nts')";
                $conn->exec($query);
                $_SESSION['porukas'] = "Uspesno ste dodali novu trafo stanicu.";
              }
            }
          }
           ?>
    ...
    function isnts(naziv)
    {
      var letters = /^[a-zA-Z\s]+$/;
      if(naziv.value.length == 0)
      {
          toastr.warning('Polje naziv mora biti popunjeno.', 'Warning',{timeOut: 8000, closeButton: true});
          naziv.focus();
          return false;
      }
      return true;
                                ...
                                <div class="au-breadcrumb-left">
                                    ...
                                    <ul class="list-unstyled list-inline au-breadcrumb__list">
                                        <li class="list-inline-item active">
                                            <a href="trafostanice.php">Admin</a>
                                        </li>
                      ...
                      <div class="container">
                          <div class="row justify-content-center" align="center">
                              <div class="col-md-6 col-lg-6">
                                  <div class="statistic__item" style="background: #3a4660;">
                                    <?php
                                    include("includes/connection.php");

                                    $query="select count(*) as total from ts";
                                    ...
                                    echo '<h2 class="number">'.$totalrow['total'].'</h2>';
                                     ?>
                                      ...
                                      <span class="desc">Ukupno trafo stanica</span>
                                      <div class="icon">
                ...
                <?php } ?>
                  ...
                  <section class="p-t-20">
                      <div class="container">
                          <div class="row justify-content-center" align="center">
                              <div class="col-md-12">
                                  <h3 class="title-5 m-b-35">Trafo stanice</h3>
                                  <div class="table-data__tool">
                                      ...
                                      <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#dts">
                                            <i class="zmdi zmdi-plus"></i>Dodaj trafo stanicu</button>
                                      ...
                                      <!-- Modal -->
                                    <div class="modal fade" id="dts" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header text-center">
                                            <h5 class="modal-title w-100" id="exampleModalLongTitle">Dodavanje nove trafo stanice</h5>
                                          ...
                                          <div class="modal-body justify-content-md-center" align="center">
                                            ...
                                            <form method="post" name="forma" enctype="multipart/form-data">
                                              <div class="form-group">
                                                <label class="col-form-label">Naziv trafo stanice:</label>
                                      ...
                                      <table class="table table-data2">
                                          ...
                                          <tbody>
                                            <?php
                                              ...
                                              $totalq="select count(*) as \"total\" from ts";
                                              ...
                                              $k=($page_current_page-1)*$page_per_page;
                                        			...
                                        			$query="select * from ts LIMIT ".$k .",".$page_per_page;
                                              $stmt = $conn->prepare($query);
                                              $stmt->execute();
                                              ...
                                              while(($row = $stmt->fetch()))
                                              {
                                                echo '  <tr class="tr-shadow">
                                                      ...
                                                      <td>
                                                          <span class="block-email">'.$row['naziv'].'</span>
                                                      </td>
                                                      <td>
                                                          <div class="table-data-feature">
                                                              <a href="izmenats.php?tsid='.$row['id'].'&page='.$page_current_page.'" class="item" data-toggle="tooltip" data-placement="top" title="Izmeni">
                                                                  <i class="zmdi zmdi-edit"></i>
                                                              </a>
                                                              <a href="obrisi.php?tsid='.$row['id'].'&page='.$page_current_page.'" class="item" data-toggle="tooltip" data-placement="top" title="Obrisi">
                                      ...
                                      <nav style="margin-top:50px;">
                                  			...
                                  			<?php  if($page_total_page>$page_current_page)
                                        {
                                          ...
                                          echo '<li class="page-item">
                                            <a class="page-link" href="trafostanice.php?page='.($page_current_page+1).'">Napred</a>
                                          </li>';
                                        }
                                  			for($i=1;$i<=$page_total_page;$i++)
                                        {
                                          ?>
                                          <li <?php if ($page_current_page == $i) { echo ' class="page-item active"'; } ?>><a class="page-link" href="trafostanice.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                          <?php
                                        }
                                        if($page_current_page>1)
                                        {
                                          echo'<li class="page-item">
                                            <a class="page-link" href="trafostanice.php?page='.($page_current_page-1).'">Nazad</a>
                                          </li>';
                                   } ?>
                                        </ul>
                                      </nav>
